...
Sirkuit sirkuit[MAX_SIRKUIT] = {
    {"Mandalika", "Pulau Lombok", "Tersedia", {"PT Mandalika Racing", "0874-2197-4638"}},
    {"Internasional Sentul", "Bogor", "Tersedia", {"Sentul Management", "0812-3958-7264"}},
    {"Jaya Ancol", "Jakarta", "Tersedia", {"Ancol Circuit Ltd", "0899-7321-4186"}},
    {"e-Prix", "Jakarta", "Tersedia", {"e-Prix Inter", "0831-5064-2987"}},
    {"Bukit Peusar", "Tasikmalaya", "Tersedia", {"Peusar Motorsports", "0852-7643-1059"}},
    {"Gokart Subang", "Subang", "Tersedia", {"Subang Racing Club", "0898-2150-7386"}},
    {"Pancing Circuit", "Medan", "Tersedia", {"Medan Racing Team", "0821-6394-5728"}},
    {"Sirkuit Skyland", "Palembang", "Tersedia", {"Skyland Motorsport", "0860-4827-3195"}},
    {"Sirkuit Balipat", "Banjarmasin", "Tersedia", {"Balipat Racing Club", "0815-9730-6241"}},
    {"Sirkuit Manado", "Manado", "Tersedia", {"Manado Speed Track", "0878-3542-6901"}}
};
int panjang = 10;
...
void bubbleSortNama(Sirkuit sirkuit[], int panjang) {
    ...
    cout << "Data berhasil diurutkan berdasarkan Nama Sirkuit.\n";
    system("pause");
}
...
void insertionSortLokasi(Sirkuit sirkuit[], int panjang) {
    ...
    cout << "Data berhasil diurutkan berdasarkan Lokasi Sirkuit.\n";
    system("pause");
}

//selection angka descend
void selectionSortKontak(Sirkuit sirkuit[], int panjang) {
    for (int i = 0; i < panjang - 1; i++) {
        int maxIndex = i;
        for (int j = i + 1; j < panjang; j++) {
            if (sirkuit[j].pengelola.kontak > sirkuit[maxIndex].pengelola.kontak) {
                maxIndex = j;
            }
        }
        if (maxIndex != i) {
    ...
    cout << "Data berhasil diurutkan berdasarkan Kontak Pengelola.\n";
    system("pause");
}
...
void menuSorting() {
    ...
    do {
        ...
        cout << "3. Urutkan Kontak Pengelola (Descending)\n";
        cout << "4. Kembali\n";
        cout << "Pilih menu: ";
        cin >> pilihSort;
        cin.ignore();
        ...
        switch (pilihSort) {
            ...
            case 2:
                ...
                break;
            case 3:
                selectionSortKontak(sirkuit, panjang);
                break;
            case 4:
...
void menuAdmin() {
    ...
    while (loggedIn) {
        ...
        else if (pilihan == 7) menuSorting();
        else if (pilihan == 8) loggedIn = false;
    }
}
...
void menuUser() {
    ...
    while (loggedIn) {
        ...
        else if (pilihan == 5) loggedIn = false;
    }
}
